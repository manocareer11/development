                ...
                <div class="row">
                    <div class="col-sm-6 logo-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <a ng-click="brand_click('GIOVANI')"><img src="image/logos/Giovani.png" class="select-logo" ng-class="selected_brand == 'GIOVANI' ? 'selected-logo' : ''"/><span ng-class="selected_brand == 'GIOVANI' ? 'selected-text' : 'hide-text'">+</span></a>
                            </div>                    
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
